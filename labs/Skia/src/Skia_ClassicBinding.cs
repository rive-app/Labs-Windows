...
public partial class Skia_ClassicBinding : Control
{
    /// <summary>
    /// Creates a new instance of the <see cref="Skia_ClassicBinding"/> class.
    /// </summary>
    public Skia_ClassicBinding()
    {
        this.DefaultStyleKey = typeof(Skia_ClassicBinding);
    }
    ...
    public static readonly DependencyProperty MyPropertyProperty = DependencyProperty.Register(
        ...
        typeof(string),
        typeof(Skia_ClassicBinding),
        new PropertyMetadata(defaultValue: string.Empty, (d, e) => ((Skia_ClassicBinding)d).OnMyPropertyChanged((string)e.OldValue, (string)e.NewValue)));

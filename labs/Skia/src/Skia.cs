...
/// You can choose to start here or from the <see cref="Skia_ClassicBinding"/> or <see cref="Skia_xBind"/> example components. Remove unused components and rename as appropriate.
/// </summary>
public partial class Skia : Panel
{
    /// <summary>
    /// Identifies the <see cref="Orientation"/> property.
    /// </summary>
    public static readonly DependencyProperty OrientationProperty =
        DependencyProperty.Register(nameof(Orientation), typeof(Orientation), typeof(Skia), new PropertyMetadata(null, OnOrientationChanged));
    ...
    {
        if (dependencyObject is Skia panel)
        {

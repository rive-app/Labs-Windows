...
/// </summary>
public partial class Skia_xBind: Control
{
    /// <summary>
    /// Creates a new instance of the <see cref="Skia_xBind"/> class.
    /// </summary>
    public Skia_xBind()
    {
        this.DefaultStyleKey = typeof(Skia_xBind);
    ...
    public static readonly DependencyProperty MyPropertyProperty = DependencyProperty.Register(
        ...
        typeof(string),
        typeof(Skia_xBind),
        new PropertyMetadata(defaultValue: string.Empty, (d, e) => ((Skia_xBind)d).OnMyPropertyChanged((string)e.OldValue, (string)e.NewValue)));
